...
y un valor de tipo lógico que indica si la persona tiene algún
tipo de discapacidad.Realice un programa que dado un vector de 
personas rellene dos nuevos vectores:uno que contenga las 
personas que no tienen ninguna discapacidad y otro que contenga 
...
int main(){
	...
	for(int i=0;i<n_personas;i++){
		...
		//Almaccenamos las personas con discapacidad
	...
	//Mostar las personas con Discapacidad
